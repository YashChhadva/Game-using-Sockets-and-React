...
const Chat = ({ location }) => {
  ...
  const welcome_message = "Welcome to the game! This is similar to hangman game except that you have to be a bollywood buff to be good at this. All the circles are hints. Top right circle is the actor name. Top right is the actress name. Bottom left is the movie name. You can guess any one of the three, however you have to write the whole name in order to get points and reveal the answer. Anyone can request for a new game. Although currently we do not have more than 7 movies so our database is kind of small. If you find it difficult to guess the names, then you can find it in the developer settings. Sorry for the trouble"
